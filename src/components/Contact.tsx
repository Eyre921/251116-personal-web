              ...
              <GlassCard className="h-full group cursor-pointer">
                <div className="flex flex-col items-center text-center">
                  <motion.div
                    ...
                    className={`p-5 rounded-2xl bg-gradient-to-br ${contact.color} mb-4`}
                  >
                    {contact.icon}
                  </motion.div>
                  <p className="font-bold text-xl text-white mb-2">{contact.label}</p>
                  {contact.link ? (
                    <motion.a
                      href={contact.link}
                      target="_blank"
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <SpotlightCard className="p-8 h-full" spotlightColor="rgba(59, 130, 246, 0.15)">
              <h3 className="text-2xl font-bold text-blue-400 mb-6">💼 {t('contact.workCommunication')}</h3>
              <div className="space-y-4">
                {workTips.map((tip, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-300 flex-1">{tip}</span>
                  </motion.div>
                ))}
              </div>
            </SpotlightCard>
          ...
          >
            <SpotlightCard className="p-8 h-full" spotlightColor="rgba(168, 85, 247, 0.15)">
              <h3 className="text-2xl font-bold text-purple-400 mb-6">🤞 {t('contact.lifeCommunication')}</h3>
